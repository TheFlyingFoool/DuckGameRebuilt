...
namespace DuckGame
{
    internal static class FPSCounter
    {
        ...
        private static GraphicsDevice _graphics = (GraphicsDevice)null;
        ...
        private static void Initialize(GraphicsDevice graphics)
        {
            ...
            FPSCounter._biosFont = new FPSCounter.BitmapFont(Texture2D.FromStream(FPSCounter._graphics, (Stream)new MemoryStream(buffer)), 8);
        ...
        '~'
            ...
            public BitmapFont(Texture2D image, int size)
            {
                ...
                for (int index1 = 0; index1 < (int)byte.MaxValue; ++index1)
                {
                    ...
                    {
                        if ((int)FPSCounter.BitmapFont._characters[index2] == (int)ch)
                        {
            ...
            public void Draw(SpriteBatch batch, string text, float xpos, float ypos, Color c)
            {
                ...
                for (int index = 0; index < text.Length; ++index)
                {
                    ...
                    {
                        int character = FPSCounter.BitmapFont._characterMap[(int)text[index]];
