        ...
        public override void Initialize()
        {
            ...
            if (this.isLocal)
            {
                ...
                for (int index = 0; index < 5; ++index)
                {
                    ...
                    {
                        if (this._blastOwner != materialThing && Duck.GetAssociatedDuck((Thing)materialThing) != this._blastOwner)
                        {
                            ...
                            Thing.SuperFondle((Thing)materialThing, DuckNetwork.localConnection);
