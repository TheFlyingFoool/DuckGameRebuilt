...
namespace DuckGame
{
    public class OptionsBeam : MaterialThing
    {
        ...
        {
            this._selectBeam.color = new Color(0.5f, (float)(0.200000002980232 + this._wave2.normalized * 0.200000002980232), (float)(0.300000011920929 + this._wave.normalized * 0.300000011920929)) * (1f + this._flash);
