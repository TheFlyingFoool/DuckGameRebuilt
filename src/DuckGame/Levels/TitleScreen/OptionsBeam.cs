...
namespace DuckGame
{
    public class OptionsBeam : MaterialThing
    {
        ...
        {
            _selectBeam.color = new Color(0.5f, (float)(0.200000002980232 + _wave2.normalized * 0.200000002980232), (float)(0.300000011920929 + _wave.normalized * 0.300000011920929)) * (1f + _flash);
