...
namespace DuckGame
{
    public class SnowParticle : WeatherParticle
    {
        ...
        public override void Draw()
        {
            ...
            DuckGame.Graphics.DrawRect(this.position + new Vec2(-num2, -num2), this.position + new Vec2(num2, num2), Color.White * alpha, (Depth)(float)(num1 * 0.100000001490116 - 0.0199999995529652));
