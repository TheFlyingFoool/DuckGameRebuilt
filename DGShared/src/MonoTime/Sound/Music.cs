...
namespace DuckGame
{
    public class Music
    {
        ...
        //private static int _currentMusic = 0;
        ...
        public static bool Load(string music, bool looping = true, float crossFadeTime = 0f)
        {
            ...
            //if (Music._currentMusic == 0)
            //{
            //    Music._currentMusic = AndroidAudio.FromFile(DuckFile.contentDirectory + str + ".ogg");
            //}
            //return true;
            ...
            if (!music.Contains(":"))
            {
                if (!music.EndsWith(".wav"))
                {
                    try
                    {
                        ...
                        {
#if __ANDROID__
                            _currentMusic = new SoundEffect(DuckFile.contentDirectory + str + ".ogg", true);
#else
...
#if __ANDROID__
            _currentMusic = new SoundEffect(music, true);
#else
        ...
        {
#if !__ANDROID__
            Music._musicPlayer.Pause();
#endif
        }

        public static void Resume() {
#if !__ANDROID__
            Music._musicPlayer.Resume(); 
#endif
        }
