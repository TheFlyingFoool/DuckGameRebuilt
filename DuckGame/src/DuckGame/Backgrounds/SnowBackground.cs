...
namespace DuckGame
{
    ...
    public class SnowBackground : BackgroundUpdater
    {
        ...
        public override void Initialize()
        {
            ...
            _parallax.AddZoneSprite(s7, 14, 0f, 0f, true);
            Sprite s8 = new Sprite("background/berg2")
            {
                depth = -0.8f,
                position = new Vec2(71f, 154f) + vec2
            };
            _parallax.AddZoneSprite(s8, 14, 0f, 0f, true);
            ...
            _parallax.AddZoneSprite(s9, 15, 0f, 0f, true);
            Sprite s10 = new Sprite("background/berg3")
            {
                depth = -0.8f,
                position = new Vec2(71f, 154f) + vec2
            };
            _parallax.AddZoneSprite(s10, 15, 0f, 0f, true);
            Level.Add(_parallax);
            if (level == null)
                return;
            level.cold = true;
