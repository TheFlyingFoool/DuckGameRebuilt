...
namespace DuckGame
{
    public class SmallFireVessel : SomethingSomethingVessel
    {
        ...
        public override void RecordUpdate()
        {
            ...
            bool addedX = false;
            if (s.stick != null && Corderator.instance.somethingMap.Contains(s.stick) && s.stick is not RagdollPart) addVal("stick", (ushort)(Corderator.instance.somethingMap[s.stick] + 1));
            else
            {
                addedX = true;
                addVal("X", (short)s.x);
