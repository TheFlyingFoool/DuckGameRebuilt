...
namespace DuckGame
{
    public class ButtonImage : Sprite
    {
        ...
        public override void Draw()
        {
            ...
            this._font.Draw(this._keyString, this.position + new Vec2((float)(_keySprite.width * (double)this.scale.x / 2.0 - (double)this._font.GetWidth(this._keyString) / 2.0), 4f * this.scale.y), new Color(20, 32, 34), this.depth + 2);
        }
    }
}
