...
//                int num1 = 2 + (int)(InputProfile.DefaultPlayer1.leftTrigger * 30);
//                int num2 = 2 + (int)(InputProfile.DefaultPlayer1.rightTrigger * 2);
//                TourneyGroup tourneyGroup1 = new TourneyGroup();
//                int num3 = 0;
//                foreach (Team p in Teams.allRandomized)
//                {
...
//                    Graphics.DrawLine(drawPos + vec2 + new Vec2(96f, 4f), drawPos + vec2 + new Vec2(96f, (float)((tourneyGroup.players.Count - 1) * (num1 + 8) + 4)), Color.White);
...
//                vec2.y = num2 + (float)((tourneyGroupList1[0].players.Count - 1) * (num1 + 8) / 2);
//                num2 = vec2.y;
