    ...
    public class TitleScreen : Level
    {
        ...
        public override void Initialize()
        {
            ...
            else
            {
                ...
                this._controlConfigMenu = (UIMenu)new UIControlConfig(this._optionsMenu, "@WRENCH@DEVICE DEFAULTS@SCREWDRIVER@", Layer.HUD.camera.width / 2f, Layer.HUD.camera.height / 2f, 194f, conString: "@WASD@@SELECT@ADJUST @CANCEL@BACK");
                this._flagMenu = (UIMenu)new UIFlagSelection(this._optionsMenu, "FLAG", Layer.HUD.camera.width / 2f, Layer.HUD.camera.height / 2f);
                this._optionsMenu.Add((UIComponent)new UIMenuItemSlider("SFX Volume", field: new FieldBinding((object)Options.Data, "sfxVolume"), step: 0.06666667f), true);
                this._optionsMenu.Add((UIComponent)new UIMenuItemSlider("Music Volume", field: new FieldBinding((object)Options.Data, "musicVolume"), step: 0.06666667f), true);
                ...
                this._optionsMenu.Add((UIComponent)new UIMenuItemSlider("Rumble Intensity", field: new FieldBinding((object)Options.Data, "rumbleIntensity"), step: 0.06666667f), true);
                ...
                this._optionsMenu.Add((UIComponent)new UIText(" ", Color.White), true);
                this._optionsMenu.Add((UIComponent)new UIMenuItem("EDIT CONTROLS", (UIMenuAction)new UIMenuActionOpenMenuCallFunction((UIComponent)this._optionsMenu, (UIComponent)this._controlConfigMenu, new UIMenuActionOpenMenuCallFunction.Function(UIControlConfig.ResetWarning)), backButton: true), true);
                ...
                this._optionsMenu.Add((UIComponent)new UIMenuItem("AUDIO", (UIMenuAction)new UIMenuActionOpenMenu((UIComponent)this._optionsMenu, (UIComponent)this._audioMenu), backButton: true), true);
                ...
                this._cloudConfigMenu.Add((UIComponent)new UIMenuItemToggle("Enable Steam Cloud", field: new FieldBinding((object)Options.Data, "cloud")), true);
                this._cloudConfigMenu.Add((UIComponent)new UIMenuItem("Manage Save Data", (UIMenuAction)new UIMenuActionOpenMenu((UIComponent)this._cloudConfigMenu, (UIComponent)this._cloudManagerMenu)), true);
                this._cloudConfigMenu.Add((UIComponent)new UIMenuItem("|DGRED|CLEAR ALL SAVE DATA", (UIMenuAction)new UIMenuActionOpenMenu((UIComponent)this._cloudConfigMenu, (UIComponent)this._cloudDeleteConfirmMenu), backButton: true), true);
                this._cloudDeleteConfirmMenu.Add((UIComponent)new UIText("This will DELETE all data", Colors.DGRed), true);
                this._cloudDeleteConfirmMenu.Add((UIComponent)new UIText("(Profiles, Options, Levels)", Colors.DGRed), true);
                this._cloudDeleteConfirmMenu.Add((UIComponent)new UIText("from your Duck Game save!", Colors.DGRed), true);
                this._cloudDeleteConfirmMenu.Add((UIComponent)new UIText("", Colors.DGRed), true);
                this._cloudDeleteConfirmMenu.Add((UIComponent)new UIText("Do not do this, unless you're", Colors.DGRed), true);
                this._cloudDeleteConfirmMenu.Add((UIComponent)new UIText("absolutely sure!", Colors.DGRed), true);
                this._cloudDeleteConfirmMenu.Add((UIComponent)new UIText(" ", Colors.DGRed), true);
                this._cloudDeleteConfirmMenu.Add((UIComponent)new UIMenuItem("|DGRED|DELETE AND RESTART.", (UIMenuAction)new UIMenuActionOpenMenuCallFunction((UIComponent)this._cloudDeleteConfirmMenu, (UIComponent)this._cloudConfigMenu, new UIMenuActionOpenMenuCallFunction.Function(this.CloudDelete))), true);
                this._cloudDeleteConfirmMenu.Add((UIComponent)new UIMenuItem("|DGGREEN|CANCEL!", (UIMenuAction)new UIMenuActionOpenMenu((UIComponent)this._cloudDeleteConfirmMenu, (UIComponent)this._cloudConfigMenu)), true);
                this._cloudDeleteConfirmMenu._defaultSelection = 1;
                this._cloudDeleteConfirmMenu.SetBackFunction((UIMenuAction)new UIMenuActionOpenMenu((UIComponent)this._cloudDeleteConfirmMenu, (UIComponent)this._cloudConfigMenu));
                ...
                {
                    this._modConfigMenu = (UIMenu)new UIModManagement(this._optionsMenu, "@WRENCH@MANAGE MODS@SCREWDRIVER@", Layer.HUD.camera.width, Layer.HUD.camera.height, 550f, conString: "@WASD@@SELECT@ADJUST @MENU1@TOGGLE @CANCEL@BACK");
                ...
                this._optionsMenu.Add((UIComponent)new UIMenuItem("SELECT FLAG", (UIMenuAction)new UIMenuActionOpenMenu((UIComponent)this._optionsMenu, (UIComponent)this._flagMenu), backButton: true), true);
                this._optionsMenu.Add((UIComponent)new UIText(" ", Color.White), true);
                if (this._accessibilityMenu != null)
                    this._optionsMenu.Add((UIComponent)new UIMenuItem("USABILITY", (UIMenuAction)new UIMenuActionOpenMenu((UIComponent)this._optionsMenu, (UIComponent)this._accessibilityMenu), backButton: true), true);
                this._optionsMenu.SetBackFunction((UIMenuAction)new UIMenuActionCloseMenuCallFunction((UIComponent)this._optionsMenu, new UIMenuActionCloseMenuCallFunction.Function(this.OptionsSaveAndClose)));
                ...
                this._optionsGroup.Add((UIComponent)(this._controlConfigMenu as UIControlConfig)._warningMenu, false);
                this._optionsGroup.Add((UIComponent)this._flagMenu, false);
                this._optionsGroup.Add((UIComponent)this._graphicsMenu, false);
                this._optionsGroup.Add((UIComponent)this._audioMenu, false);
                if (this._accessibilityMenu != null)
                    this._optionsGroup.Add((UIComponent)this._accessibilityMenu, false);
                if (this._ttsMenu != null)
                    this._optionsGroup.Add((UIComponent)this._ttsMenu, false);
                if (this._blockMenu != null)
                    this._optionsGroup.Add((UIComponent)this._blockMenu, false);
                if (MonoMain.moddingEnabled)
                {
                    this._optionsGroup.Add((UIComponent)this._modConfigMenu, false);
                    this._optionsGroup.Add((UIComponent)(this._modConfigMenu as UIModManagement)._modSettingsMenu, false);
                ...
                this._optionsGroup.Add((UIComponent)this._cloudManagerMenu, false);
                this._optionsGroup.Add((UIComponent)this._cloudManagerMenu._deleteMenu, false);
                ...
                this._quitMenu.Add((UIComponent)new UIMenuItem("NO!", (UIMenuAction)new UIMenuActionOpenMenu((UIComponent)this._quitMenu, (UIComponent)this._mainPauseMenu)), true);
                this._quitMenu.Add((UIComponent)new UIMenuItem("YES!", (UIMenuAction)new UIMenuActionCloseMenuSetBoolean(this._pauseGroup, this._quit)), true);
                this._quitMenu.Close();
                this._pauseGroup.Add((UIComponent)this._quitMenu, false);
                ...
                this._parentalControlsMenu.Add((UIComponent)new UIText("Certain online features have been", Color.White), true);
                this._parentalControlsMenu.Add((UIComponent)new UIText("disabled by Parental Controls.", Color.White), true);
                this._parentalControlsMenu.Add((UIComponent)new UIText("", Color.White), true);
                this._parentalControlsMenu.Add((UIComponent)new UIMenuItem("OK", (UIMenuAction)new UIMenuActionCloseMenu(this._pauseGroup)), true);
                this._parentalControlsMenu.Close();
                this._pauseGroup.Add((UIComponent)this._parentalControlsMenu, false);
                int pMinLength = 50;
                float num1 = 3f;
                ...
                duckGameUpdateMenu1.Add((UIComponent)component1, true);
                ...
                duckGameUpdateMenu2.Add((UIComponent)component2, true);
                ...
                duckGameUpdateMenu3.Add((UIComponent)component3, true);
                ...
                duckGameUpdateMenu4.Add((UIComponent)component4, true);
                ...
                duckGameUpdateMenu5.Add((UIComponent)component5, true);
                ...
                duckGameUpdateMenu6.Add((UIComponent)component6, true);
                ...
                duckGameUpdateMenu7.Add((UIComponent)component7, true);
                ...
                duckGameUpdateMenu8.Add((UIComponent)component8, true);
                ...
                duckGameUpdateMenu9.Add((UIComponent)component9, true);
                ...
                duckGameUpdateMenu10.Add((UIComponent)component10, true);
                ...
                duckGameUpdateMenu11.Add((UIComponent)component11, true);
                ...
                duckGameUpdateMenu12.Add((UIComponent)component12, true);
                ...
                duckGameUpdateMenu13.Add((UIComponent)component13, true);
                ...
                duckGameUpdateMenu14.Add((UIComponent)component14, true);
                ...
                duckGameUpdateMenu15.Add((UIComponent)component15, true);
                ...
                duckGameUpdateMenu16.Add((UIComponent)component16, true);
                ...
                duckGameUpdateMenu17.Add((UIComponent)component17, true);
                this._duckGameUpdateMenu.SetAcceptFunction((UIMenuAction)new UIMenuActionCloseMenu(this._pauseGroup));
                this._duckGameUpdateMenu.SetBackFunction((UIMenuAction)new UIMenuActionCloseMenu(this._pauseGroup));
                this._duckGameUpdateMenu.Close();
                this._pauseGroup.Add((UIComponent)this._duckGameUpdateMenu, false);
                ...
                steamWarningMessage1.Add((UIComponent)component18, true);
                ...
                component19.scale = new Vec2(0.5f);
                steamWarningMessage2.Add((UIComponent)component19, true);
                ...
                component20.scale = new Vec2(0.5f);
                steamWarningMessage3.Add((UIComponent)component20, true);
                UIMenu steamWarningMessage4 = this._steamWarningMessage;
                UIText component21 = new UIText("", Color.White, heightAdd: -3f);
                component21.scale = new Vec2(0.5f);
                steamWarningMessage4.Add((UIComponent)component21, true);
                ...
                component22.scale = new Vec2(0.5f);
                steamWarningMessage5.Add((UIComponent)component22, true);
                ...
                component23.scale = new Vec2(0.5f);
                steamWarningMessage6.Add((UIComponent)component23, true);
                ...
                component24.scale = new Vec2(0.5f);
                steamWarningMessage7.Add((UIComponent)component24, true);
                UIMenu steamWarningMessage8 = this._steamWarningMessage;
                UIText component25 = new UIText("", Color.White, heightAdd: -3f);
                component25.scale = new Vec2(0.5f);
                steamWarningMessage8.Add((UIComponent)component25, true);
                this._steamWarningMessage.SetAcceptFunction((UIMenuAction)new UIMenuActionCloseMenu(this._pauseGroup));
                this._steamWarningMessage.SetBackFunction((UIMenuAction)new UIMenuActionCloseMenu(this._pauseGroup));
                this._steamWarningMessage.Close();
                this._pauseGroup.Add((UIComponent)this._steamWarningMessage, false);
                ...
                component26.scale = new Vec2(0.5f);
                modsDisabledMenu1.Add((UIComponent)component26, true);
                ...
                component27.scale = new Vec2(0.5f);
                modsDisabledMenu2.Add((UIComponent)component27, true);
                ...
                component28.scale = new Vec2(0.5f);
                modsDisabledMenu3.Add((UIComponent)component28, true);
                UIMenu modsDisabledMenu4 = this._modsDisabledMenu;
                UIText component29 = new UIText("", Color.White, heightAdd: -3f);
                component29.scale = new Vec2(0.5f);
                modsDisabledMenu4.Add((UIComponent)component29, true);
                ...
                component30.scale = new Vec2(0.5f);
                modsDisabledMenu5.Add((UIComponent)component30, true);
                ...
                component31.scale = new Vec2(0.5f);
                modsDisabledMenu6.Add((UIComponent)component31, true);
                ...
                component32.scale = new Vec2(0.5f);
                modsDisabledMenu7.Add((UIComponent)component32, true);
                ...
                component33.scale = new Vec2(0.5f);
                modsDisabledMenu8.Add((UIComponent)component33, true);
                UIMenu modsDisabledMenu9 = this._modsDisabledMenu;
                UIText component34 = new UIText("", Color.White, heightAdd: -3f);
                component34.scale = new Vec2(0.5f);
                modsDisabledMenu9.Add((UIComponent)component34, true);
                ...
                component35.scale = new Vec2(0.5f);
                modsDisabledMenu10.Add((UIComponent)component35, true);
                UIMenu modsDisabledMenu11 = this._modsDisabledMenu;
                UIText component36 = new UIText("", Color.White, heightAdd: -3f);
                component36.scale = new Vec2(0.5f);
                modsDisabledMenu11.Add((UIComponent)component36, true);
                ...
                component37.scale = new Vec2(0.5f);
                modsDisabledMenu12.Add((UIComponent)component37, true);
                ...
                component38.scale = new Vec2(0.5f);
                modsDisabledMenu13.Add((UIComponent)component38, true);
                ...
                component39.scale = new Vec2(0.5f);
                modsDisabledMenu14.Add((UIComponent)component39, true);
                UIMenu modsDisabledMenu15 = this._modsDisabledMenu;
                UIText component40 = new UIText("", Color.White, heightAdd: -3f);
                component40.scale = new Vec2(0.5f);
                modsDisabledMenu15.Add((UIComponent)component40, true);
                this._modsDisabledMenu.SetAcceptFunction((UIMenuAction)new UIMenuActionCloseMenu(this._pauseGroup));
                this._modsDisabledMenu.SetBackFunction((UIMenuAction)new UIMenuActionCloseMenu(this._pauseGroup));
                this._modsDisabledMenu.Close();
                this._pauseGroup.Add((UIComponent)this._modsDisabledMenu, false);
                UIDivider component41 = new UIDivider(true, 0.8f);
                component41.rightSection.Add((UIComponent)new UIImage("pauseIcons", UIAlign.Right), true);
                this._mainPauseMenu.Add((UIComponent)component41, true);
                component41.leftSection.Add((UIComponent)new UIMenuItem("RESUME", (UIMenuAction)new UIMenuActionCloseMenu(this._pauseGroup)), true);
                component41.leftSection.Add((UIComponent)new UIMenuItem("OPTIONS", (UIMenuAction)new UIMenuActionOpenMenu((UIComponent)this._mainPauseMenu, (UIComponent)Options.optionsMenu), UIAlign.Left), true);
                component41.leftSection.Add((UIComponent)new UIMenuItem("CREDITS", (UIMenuAction)new UIMenuActionCloseMenuSetBoolean(this._pauseGroup, this._enterCreditsMenuBool), UIAlign.Left), true);
                component41.leftSection.Add((UIComponent)new UIText("", Color.White), true);
                component41.leftSection.Add((UIComponent)new UIMenuItem("|DGRED|QUIT", (UIMenuAction)new UIMenuActionOpenMenu((UIComponent)this._mainPauseMenu, (UIComponent)this._quitMenu)), true);
                Options.openOnClose = this._mainPauseMenu;
                Options.AddMenus(this._pauseGroup);
                this._mainPauseMenu.Close();
                this._pauseGroup.Add((UIComponent)this._mainPauseMenu, false);
                ...
                {
                    SpaceTileset t = new SpaceTileset((float)(index * 16 - 6), 176f);
                    t.frame = 3;
                    t.layer = Layer.Game;
                    t.setLayer = false;
                    this.AddThing((Thing)t);
                }
                ...
                Level.Add((Thing)new Spring(90f, 160f, 0.32f));
                Level.Add((Thing)new Spring(229f, 160f, 0.32f));
                Level.Add((Thing)new VerticalDoor(270f, 160f)
                {
                    filterDefault = true
                });
        ...
        public override void Update()
        {
            if (this._duck != null && DGSave.showOnePointFiveMessages)
            {
                ...
                {
                    MonoMain.pauseMenu = (UIComponent)this._duckGameUpdateMenu;
                ...
                {
                    MonoMain.pauseMenu = (UIComponent)this._modsDisabledMenu;
            ...
            for (int index = 0; index < num; ++index)
            {
                ...
                {
                    particle.pos += particle.speed * (float)(0.5 + (1.0 - (double)this.extraFade) * 0.5);
                    ...
                    else
                    {
                        ...
                        if ((double)this.switchWait <= 0.0)
                        {
                            ...
                            else
                            {
                                ...
                                if ((double)this.creditsScroll > 939.0)
                                {
                                    ...
                                    if ((double)this.extraFade < 0.0)
                                        this.extraFade = 0.0f;
                                }
                                if ((double)this.creditsScroll > 2650.0 && !this.shownPrompt)
                                {
            ...
            if (this._fadeIn && !this._fadeInFull)
            {
                ...
                {
                    MonoMain.pauseMenu = (UIComponent)this._parentalControlsMenu;
        ...
        public override void PostDrawLayer(Layer layer)
        {
            if (layer == Layer.Foreground)
            {
                ...
                else
                {
                    ...
                    if ((double)this._pressStartBlink >= 0.5)
                    {
            ...
            else if (layer == Layer.Background)
            {
                foreach (StarParticle particle in this.particles)
                {
                    ...
                    Graphics.DrawRect(particle.pos, particle.pos + new Vec2(1f, 1f), Color.White * (float)(((double)num4 + (double)num3 * 0.600000023841858) * (0.300000011920929 + (1.0 - (double)this.extraFade) * 0.699999988079071)), - 0.3f);
                    float num5 = 0.1f;
                    if ((double)this.camera.y > 0.0)
                    ...
                    for (int index = 0; index < num6; ++index)
                    {
                        ...
                        Graphics.DrawLine(pos + new Vec2(-num7, 0.5f), pos + new Vec2(0.0f, 0.5f), particle.color * ((float)(1.0 - (double)index / (double)num6) * num5) * (float)(0.300000011920929 + (1.0 - (double)this.extraFade) * 0.699999988079071), depth: (- 0.4f));
                        pos.x -= num7;
                    }
                }
