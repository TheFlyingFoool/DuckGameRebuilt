    ...
    public class Arcade : Level
    {
        ...
        public override void Initialize()
        {
          ...
          "challenge/grapple04"
            ...
            component.leftSection.Add((UIComponent)new UIMenuItem("EXIT ARCADE", (UIMenuAction)new UIMenuActionOpenMenu((UIComponent)this._pauseMenu, (UIComponent)this._confirmMenu), UIAlign.Left), true);
