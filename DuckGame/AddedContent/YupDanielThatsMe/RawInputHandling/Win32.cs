...
namespace RawInput
{
    static public class Win32
    {
        ...
        public const int WM_IME_SETCONTEXT = 0x0281; // On window activation 
        ...
        {
            FileStream file = new FileStream("DeviceAudit.txt", FileMode.Create, FileAccess.Write);
            ...
            if (GetRawInputDeviceList(IntPtr.Zero, ref deviceCount, (uint)dwSize) == 0)
            {
                ...
                for (int i = 0; i < deviceCount; i++)
                {
                    ...
                    DeviceInfo di = new DeviceInfo { Size = Marshal.SizeOf(typeof(DeviceInfo)) };
        ...
        public static string GetDeviceDescription(string device)
        {
            ...
            try
            {
                Microsoft.Win32.RegistryKey deviceKey = RegistryAccess.GetDeviceKey(device);
