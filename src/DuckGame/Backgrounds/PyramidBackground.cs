...
namespace DuckGame
{
    ...
    public class PyramidBackground : BackgroundUpdater
    {
        ...
        public override void Initialize()
        {
            ...
            this._parallax = new ParallaxBackground("background/pyramid", 0f, 0f, 3);
            float speed = 0.4f;
            this._parallax.AddZone(0, 1f, 0f);
            this._parallax.AddZone(1, 1f, 0f);
            this._parallax.AddZone(2, 1f, 0f);
            this._parallax.AddZone(3, 1f, 0f);
            this._parallax.AddZone(4, 1f, 0f);
            this._parallax.AddZone(5, 1f, 0f);
            this._parallax.AddZone(6, 1f, 0f);
            this._parallax.AddZone(7, 1f, 0f);
            this._parallax.AddZone(8, 1f, 0f);
            this._parallax.AddZone(9, 1f, 0f);
            this._parallax.AddZone(10, 1f, 0f);
            this._parallax.AddZone(11, 1f, 0f);
            this._parallax.AddZone(12, 1f, 0f);
            this._parallax.AddZone(13, 1f, 0f);
            this._parallax.AddZone(14, 1f, 0f);
            this._parallax.AddZone(15, 1f, 0f);
            this._parallax.AddZone(16, 1f, 0f);
            this._parallax.AddZone(17, 1f, 0f);
