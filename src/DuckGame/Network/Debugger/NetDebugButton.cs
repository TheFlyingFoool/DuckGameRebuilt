    ...
    public class NetDebugButton : NetDebugElement
    {
        ...
        protected override bool Draw(Vec2 position, bool allowInput)
        {
            ...
            if (!flag && rectangle.Contains(Mouse.positionConsole) || this.pressing)
            {
                ...
                Graphics.DrawString(this._name, position + new Vec2((float)((double)vec2.x / 2.0 - (double)Graphics.GetStringWidth(this._name) / 2.0), 2f), Color.White * 1f, this.depth + 10);
            ...
            else
            {
                ...
                Graphics.DrawString(this._name, position + new Vec2((float)((double)vec2.x / 2.0 - (double)Graphics.GetStringWidth(this._name) / 2.0), 2f), Color.White * 0.8f, this.depth + 10);
            }
