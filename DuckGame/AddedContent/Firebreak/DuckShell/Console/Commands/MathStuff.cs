...
namespace DuckGame.ConsoleEngine
{
    ...
    {
        [Marker.DSHCommand(Name = "+", Description = "Adds 2 numbers.", Hidden = true)]
        public static double Add(double a, double b) => a + b;

        [Marker.DSHCommand(Name = "-", Description = "Subtracts 2 numbers.", Hidden = true)]
        public static double Subtract(double a, double b) => a - b;

        [Marker.DSHCommand(Name = "*", Description = "Multiplies 2 numbers.", Hidden = true)]
        public static double Multiply(double a, double b) => a * b;

        [Marker.DSHCommand(Name = "/", Description = "Divides 2 numbers.", Hidden = true)]
        public static double Divide(double a, double b) => a / b;

        [Marker.DSHCommand(Name = "^", Description = "Raises a number to the power of another number.", Hidden = true)]
