...
namespace DuckGame
{
    public class NMPop : NMEvent
    {
        ...
        public static void AmazingDisappearingParticles(Vec2 pPos)
        {
            ...
            {
                Level.Add(ConfettiParticle.New(pPos.x + Rando.Float(-6f, 0.0f), pPos.y + Rando.Float(-6f, 6f), new Vec2(Rando.Float(-1f, 0.0f), Rando.Float(-1f, 1f))));
                Level.Add(ConfettiParticle.New(pPos.x + Rando.Float(0.0f, 6f), pPos.y + Rando.Float(-6f, 6f), new Vec2(Rando.Float(0.0f, 1f), Rando.Float(-1f, 1f))));
                Level.Add(ConfettiParticle.New(pPos.x + Rando.Float(-6f, 0.0f), pPos.y + Rando.Float(-6f, 6f), new Vec2(Rando.Float(-1f, 0.0f), Rando.Float(-1f, 1f)), lineType: true));
                Level.Add(ConfettiParticle.New(pPos.x + Rando.Float(0.0f, 6f), pPos.y + Rando.Float(-6f, 6f), new Vec2(Rando.Float(0.0f, 1f), Rando.Float(-1f, 1f)), lineType: true));
            }
