...
namespace DuckGame
{
    public class TeamsCore
    {
        ...
        public void Initialize()
        {
            ...
            //yes this is fucking idiotic -NiK0
            //whenever DG gets an update make sure to add the new default hats to both lists
            
            //you may ask why is it this way?
            //i respond, to easily toggle on and off fifty player mode this is about the best solution i could think of
            //that doens't involve re-assignining this entire list whenever its toggled on or off
            _vanillaTeams = new List<Team>()
            {
