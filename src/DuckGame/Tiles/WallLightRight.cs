    ...
    public class WallLightRight : Thing
    {
        ...
        public override void Initialize()
        {
            if (Level.current is Editor)
                return;
            this._occluders.Add(new LightOccluder(this.topLeft, this.topRight + new Vec2(2f, 0f), new Color(1f, 0.8f, 0.8f)));
            this._occluders.Add(new LightOccluder(this.bottomLeft, this.bottomRight + new Vec2(2f, 0f), new Color(1f, 0.8f, 0.8f)));
