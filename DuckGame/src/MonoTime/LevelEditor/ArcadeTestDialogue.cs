...
namespace DuckGame
{
    public class ArcadeTestDialogue : ContextMenu
    {
        ...
        public override void Initialize()
        {
            ...
            float num1 = 300f;
            float num2 = 40f;
            Vec2 vec2_1 = new Vec2((float)(layer.width / 2f - num1 / 2f), (layer.height / 2f - num2 / 2f));
            Vec2 vec2_2 = new Vec2((float)(layer.width / 2f + num1 / 2f), (layer.height / 2f + num2 / 2f));
        ...
        public override void Update()
        {
            ...
            float num1 = 316f;
            float num2 = 155f;
            Vec2 vec2_1 = new Vec2((layer.width / 2f - num1 / 2f), (layer.height / 2f - num2 / 2f));
            Vec2 vec2_2 = new Vec2((layer.width / 2f + num1 / 2f), (layer.height / 2f + num2 / 2f));
        ...
        public override void Draw()
        {
            ...
            float num1 = 316f;
            float num2 = 155f;
            Vec2 p1_1 = new Vec2((layer.width / 2f - num1 / 2f), (layer.height / 2f - num2 / 2f));
            Vec2 p2 = new Vec2((layer.width / 2f + num1 / 2f), (layer.height / 2f + num2 / 2f));
            ...
            _font.Draw("CANCEL", (float)(p1_4.x + vec2_3.x / 2f - _font.GetWidth(text2) / 2f - 4f), p1_4.y + 8f, Color.White, depth + 3);
        }
    }
}
