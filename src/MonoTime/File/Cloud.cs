        ...
        public class UICloudProcess : UIMenu
        {
            ...
            public override void Draw()
            {
                if (this.open)
                {
                    ...
                    Graphics.DrawRect(new Rectangle((float)((double)this._box.x - (double)this._box.halfWidth + 8.0), this._box.y, Lerp.FloatSmooth(0.0f, this._box.width - 16f, Cloud.progress), 10f), Color.White, (Depth)0.8f);
