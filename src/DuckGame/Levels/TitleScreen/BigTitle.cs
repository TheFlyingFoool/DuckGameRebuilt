...
namespace DuckGame
{
    public class BigTitle : Thing
    {
        ...
        public bool didloadtexture = true;
        ...
        public BigTitle() : base()
        {
            _sprite = new Sprite("title/logo");
        ...
        public override void Draw()
        {
            ...
            Graphics.DrawRect(position + new Vec2(-300f, -38.5f), position + new Vec2(300f, 64f), Color.Black * 0.6f * alpha, depth - 100);
            //if (_showFart)
            //{
            //    _demo.alpha = alpha;
