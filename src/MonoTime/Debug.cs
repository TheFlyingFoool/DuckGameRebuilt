...
namespace DuckGame
{
    public static class Debug
    {
        ...
        [Conditional("DEBUG")]
        public static void DrawRect(Vec2 p1, Vec2 p2, Color col) => DuckGame.Graphics.Draw((Tex2D)Debug._blank, p1, new Rectangle?(), col, 0f, Vec2.Zero, new Vec2((float)-(p1.x - p2.x), (float)-(p1.y - p2.y)), SpriteEffects.None, (Depth)1f);
