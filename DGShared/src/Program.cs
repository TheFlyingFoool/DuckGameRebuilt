...
namespace DuckGame
{
    ...
    public static class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            {
                if (args.Name == "System.Runtime.CompilerServices.RuntimeCompatibilityAttribute")
                {
                    return typeof(System.Runtime.CompilerServices.RuntimeCompatibilityAttribute).Assembly;
                }
                return null;
            };
#endif
...
#if __ANDROID__
            Directory.SetCurrentDirectory(MainActivity.DocPath);
#else
        ...
        {
#if __ANDROID__
            File.AppendAllText(MainActivity.DocPath + "Error.txt", args.Name.ToString() + " " + args.RequestingAssembly.ToString());
#endif
            if (!enteredMain)
                return null;
...
#if !__ANDROID__ // On Android, let that side call it.
            main.Run();
#endif
        }
        ...
        public static void SendCrashToServer(Exception pException)
        {
            ...
            try
            {
                ...
                if (DiscordRichPresence.client != null && DiscordRichPresence.client.IsInitialized)
                {
