...
namespace DuckGame
{
    public class FurniShopScreen : Thing
    {
        ...
        {
            HUD.AddCornerCounter(HUDCorner.TopRight, "@TICKET@ ", new FieldBinding((object)Profiles.active[0], "ticketCount"), animateCount: true);
        ...
        public override void Draw()
        {
            ...
            Graphics.DrawString(text, p1 + new Vec2((float)(((double)vec2.x - 27.0) / 2.0 - (double)Graphics.GetStringWidth(text) / 2.0), 2f), new Color(163, 206, 39) * this.alpha, (Depth)0.97f);
