    ...
    public class UISideButton : UIComponent
    {
        ...
        public override void Draw()
        {
            ...
            if (_borderVisible)
            {
                ...
                _sections.frame = 0;
                Graphics.Draw(ref _sections, -halfWidth + x, -halfHeight + y);
                _sections.frame = 2;
                Graphics.Draw(ref _sections, (float)(halfWidth + x - _sections.w * scale.x), -halfHeight + y);
                _sections.frame = 1;
                ...
                Graphics.Draw(ref _sections, -halfWidth + x, (float)(-halfHeight + y + _sections.h * scale.y));
                _sections.frame = 5;
                Graphics.Draw(ref _sections, (float)(halfWidth + x - _sections.w * scale.x), (float)(-halfHeight + y + _sections.h * scale.y));
                _sections.frame = 4;
                _sections.xscale = (_collisionSize.x - _sections.w * 2) / _sections.w * xscale;
                Graphics.Draw(ref _sections, (float)(-halfWidth + x + _sections.w * scale.x), (float)(-halfHeight + y + _sections.h * scale.y));
                _sections.xscale = xscale;
