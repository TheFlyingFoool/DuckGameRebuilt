...
namespace DuckGame
{
    ...
    public class SnowBackground : BackgroundUpdater
    {
        ...
        public override void Initialize()
        {
            ...
            this._parallax = new ParallaxBackground("background/snowSky", 0f, 0f, 3);
            float speed = 0.2f;
            ...
            this._parallax.AddZoneSprite(s7, 14, 0f, 0f, true);
            Sprite s8 = new Sprite("background/berg2")
            {
                depth = -0.8f,
                position = new Vec2(71f, 154f) + vec2
            };
            this._parallax.AddZoneSprite(s8, 14, 0f, 0f, true);
            ...
            this._parallax.AddZoneSprite(s9, 15, 0f, 0f, true);
            Sprite s10 = new Sprite("background/berg3")
            {
                depth = -0.8f,
                position = new Vec2(71f, 154f) + vec2
            };
            this._parallax.AddZoneSprite(s10, 15, 0f, 0f, true);
            Level.Add(_parallax);
            if (this.level == null)
                return;
