...
namespace DuckGame
{
    public class Pedestal : Thing
    {
          ...
          : base(xpos, ypos)
        {
            ...
            this.center = new Vec2(this._sprite.w / 2, _sprite.h);
            ...
            if (Network.isServer)
            {
                ...
                foreach (Profile activeProfile in team.activeProfiles)
                {
                    ...
                    Duck duck = new Duck(xpos - num2 / 2f + num1 * 10, this.GetYOffset() - 15f, activeProfile)
                    {
                        depth = (Depth)0.06f
                    };
                    Level.Add(duck);
            ...
            Level.Add(new Platform(xpos - 17f, this.GetYOffset(), 34f, 16f));
            Level.Add(new Block(-6f, this.GetYOffset() - 100f, 6f, 200f));
            Level.Add(new Block(320f, this.GetYOffset() - 100f, 6f, 200f));
